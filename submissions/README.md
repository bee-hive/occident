...
2. Learn about our tab-delimited file format (TSV) and provide metadata on multiple trials and multiple wells (one per row) using a template of required column headings.

A [template TSV file](TEMPLATE.tsv) is included in this folder. Each of the columns is described in detail below.
